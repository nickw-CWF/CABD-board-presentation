...
- Remediation projects are expensive
...
- Identify and prioritize barriers for remediation
...
- Launch external engagement to get input on design
...
<center>
![CRI](./img/cri-logo.png){height=50px} ![TUC](./img/tuc-logo.png){height=50px} ![NRCan](./img/nrcan-logo.png){height=25px}
...
- Establish **<span style="color: #de3c26;">reciprocal</span>** relationships
  + Quality and consistency to fill data gaps
...
## CABD Outcomes
- Open data on **<span style="color: #de3c26;">all aquatic barriers</span>**
- Identify high priority barriers for removal (local, regional, and national scales)
- Support connectivity research, barrier prioritization, and fish passage remediation
- Support Canada-wide collaboration on freshwater connectivity issues
...
- Development of CABD has positioned CWF as a leader in Canada and beyond
- Multiple existing and potential collaboration opportunities across sectors

## Watershed Connectivity Remediation Planning framework

<div class="container">
<div class="col">
- Collaborative, strategic framework to plan barrier remediation developed and piloted in B.C.
  + Watershed plans supported by data included in CABD
  + Opportunity to apply in Alberta
- Guide document for connectivity planning in Canada
- CABD will support future watershed-scale planning work
</div>
...
<div class="container">
<div class="col">
- DFO mandated to provide status report on fish and fish habitat in Canada (under new Fisheries Act)
...
<div class="container">
<div class="col">
- Member of the Connectivity Working Group (Pathway to Canada Target 1)
...
<div class="container">
<div class="col">
- International research collaborative developing comprehensive and curated dam datasets
...
## Long-term Future of the CABD

- Continue partnership and collaboration opportunities
- Develop additional tools
- Planning for long-term management and maintenance

## Additional Tools

- Barrier assessment protocols
  + Series of regional workshops in winter/spring 2022
- Research partnerships to develop tools to:
  + Identify barriers
  + Estimate passability

## Additional Tools

- Barrier prioritization and reporting tools accessible through CABD webmap
...
- Long-term maintenance mode will require lower costs - challenge with db like this
